...
const columnDefs_entries: ColDef[] = [
    { field: 'id', headerName: 'ID', filter: false, sortable: true, type: "number", maxWidth: 100 },
    {
        field: 'objectIdentityId', headerName: 'OID', filter: false, sortable: true, type: "number", flex: 1, cellRenderer: params => {
    ...
    {
        field: 'mask', headerName: '권한', filter: false, sortable: true, type: "string", maxWidth: 120, cellRenderer: params => {
