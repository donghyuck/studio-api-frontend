import { createObjectIdentity, deleteObjectIdentity } from "@/data/studio/acl";
...
class AclObjectsDataSource extends AbstractPageDataSource implements IAclObjectsDataSource{
